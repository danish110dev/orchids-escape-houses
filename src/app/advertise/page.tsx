        ...
        <div className="max-w-[1200px] mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl text-[var(--color-neutral-dark)] leading-relaxed">
                Join the UK's leading platform for luxury group accommodation. Reach thousands of guests looking for weddings, celebrations, and unforgettable group getaways.
              </p>
