...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Group Weekend Breaks & Short Stays | Group Escape Houses",
    description: "Luxury weekend breaks for groups. 2-3 nights from £69pp with hot tubs and entertainment.",
    url: "https://groupescapehouses.co.uk/weekend-breaks",
  },
  alternates: {
    canonical: "https://groupescapehouses.co.uk/weekend-breaks",
  },
};
