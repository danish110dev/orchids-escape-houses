...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  // Inspiration posts (static for now)
  const inspirationPosts = [
    'alternative-hen-party-ideas',
    'brighton-hen-do-guide',
  ];

  const inspirationRoutes: MetadataRoute.Sitemap = inspirationPosts.map((slug) => ({
  ...
  const holidayFocusRoutes: MetadataRoute.Sitemap = [
    'adventure-holidays', 'book-private-chef', 
    'business-offsite-corporate-accommodation', 'girls-weekend-getaways', 
    'group-city-breaks', 'multi-generational-holidays', 'retreat-venues', 
    'rural-retreats', 'youth-school-group-accommodation'
  ].map((slug) => ({
