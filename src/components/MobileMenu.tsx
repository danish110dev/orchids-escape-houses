...
import { X, ChevronDown, User as UserIcon, LogOut } from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-8">
          ...
          <nav className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              >
                House Styles
                <ChevronDown className={`w-5 h-5 transition-transform ${isStylesOpen ? "rotate-180" : ""}`} />
              </button>
              {isStylesOpen && (
              ...
              >
                Must-Have Features
                <ChevronDown className={`w-5 h-5 transition-transform ${isFeaturesOpen ? "rotate-180" : ""}`} />
              </button>
              {isFeaturesOpen && (
                <div className="pl-4 space-y-2 text-[var(--color-neutral-dark)]">
            ...
            <div className="space-y-3">
              ...
              >
                View By Occasion
                <ChevronDown className={`w-5 h-5 transition-transform ${isOccasionsOpen ? "rotate-180" : ""}`} />
              </button>
              {isOccasionsOpen && (
                <div className="pl-4 space-y-2 text-[var(--color-neutral-dark)]">
        ...
        {isPending ? (
          ...
          <>
            <div className="flex items-center justify-between p-4 bg-white/90 rounded-xl">
              ...
              <Button onClick={onSignOut} size="sm" variant="outline" className="border-red-500 text-red-600">
                <LogOut className="w-4 h-4" />
              </Button>
            </div>
            <Button asChild size="lg" className="w-full rounded-2xl bg-[var(--color-accent-sage)] text-white">
              <Link href="/contact" onClick={onClose}>Check Availability and Book</Link>
            </Button>
          </>
        ) : (
          <>
            <div className="grid grid-cols-2 gap-3">
              ...
              <Button asChild size="lg" className="rounded-2xl bg-[var(--color-accent-gold)] text-white">
