      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1">
            ...
            <p className="text-sm text-[var(--color-bg-secondary)] leading-relaxed">
              Luxury hen party houses designed for unforgettable celebrations.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/properties" className="hover:text-[var(--color-accent-pink)] transition-colors">
                  Properties
                </Link>
              </li>
              <li>
                <Link href="/experiences" className="hover:text-[var(--color-accent-pink)] transition-colors">
                  Experiences
                </Link>
              </li>
              <li>
                <Link href="/destinations" className="hover:text-[var(--color-accent-pink)] transition-colors">
                  Destinations
                </Link>
              </li>
              <li>
                <Link href="/how-it-works" className="hover:text-[var(--color-accent-pink)] transition-colors">
                  How it works
                </Link>
              </li>
              <li>
                <Link href="/reviews" className="hover:text-[var(--color-accent-pink)] transition-colors">
                  Reviews
                </Link>
              </li>
              <li>
                <Link href="/blog" className="hover:text-[var(--color-accent-pink)] transition-colors">
                  Blog
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-full bg-[var(--color-accent-sage)] flex items-center justify-center hover:-translate-y-1 hover:bg-[var(--color-accent-pink)] transition-all duration-200"
              >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-[var(--color-bg-secondary)]">
          ...
          <div className="flex gap-6">
            <Link href="/terms" className="hover:text-[var(--color-accent-pink)] transition-colors">
              Terms
            </Link>
            <Link href="/privacy" className="hover:text-[var(--color-accent-pink)] transition-colors">
              Privacy
            </Link>
            <Link href="/cookies" className="hover:text-[var(--color-accent-pink)] transition-colors">
              Cookies
            </Link>
          </div>
        </div>
