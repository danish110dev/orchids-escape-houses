...
export default function StructuredData({ type = "home", data }: StructuredDataProps) {
  ...
  const organizationSchema = {
    ...
    logo: "https://www.groupescapehouses.co.uk/logo.png",
  ...
  const websiteSchema = {
    ...
    potentialAction: {
      ...
      target: {
        "@type": "EntryPoint",
        urlTemplate: "https://www.groupescapehouses.co.uk/properties?search={search_term_string}"
      },
      ...
      ...(type === "property" ? [
        {
          ...
          position: 2,
          name: "Properties",
          item: "https://www.groupescapehouses.co.uk/properties"
        },
        ...(data?.propertyName ? [{
          "@type": "ListItem",
          position: 3,
          name: data.propertyName,
          item: `https://www.groupescapehouses.co.uk/properties/${data.slug}`
        }] : [])
      ] : []),
      ...(type === "experience" ? [
        {
          ...
          position: 2,
          name: "Experiences",
          item: "https://www.groupescapehouses.co.uk/experiences"
        },
        ...(data?.experienceName ? [{
          "@type": "ListItem",
          position: 3,
          name: data.experienceName,
          item: `https://www.groupescapehouses.co.uk/experiences/${data.slug}`
        }] : [])
      ] : []),
      ...(type === "destination" ? [
        {
          ...
          position: 2,
          name: "Destinations",
          item: "https://www.groupescapehouses.co.uk/destinations"
        },
        ...(data?.destinationName ? [{
          "@type": "ListItem",
          position: 3,
          name: data.destinationName,
          item: `https://www.groupescapehouses.co.uk/destinations/${data.slug}`
        }] : [])
      ] : [])
    ]
  };
    ...
    itemListElement: [
      {
        ...
        item: {
          "@type": "Product",
          "@id": "https://www.groupescapehouses.co.uk/properties/brighton-manor",
      ...
      },
      {
        ...
        item: {
          "@type": "Product",
          "@id": "https://www.groupescapehouses.co.uk/properties/bath-spa-retreat",
      ...
      },
      {
        ...
        item: {
          "@type": "Product",
          "@id": "https://www.groupescapehouses.co.uk/properties/manchester-party-house",
